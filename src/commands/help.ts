...
const COMMAND_INFO = {
  ...
  config: {
    ...
    details: '**⚙️ Configuration Overview**\n\n**Roles:**\n- **🔧 Blamer Role** — Allows `/blame`, `/unblame`, `/revert`.\n- **❄️ Frozen Role** — Blocks all bot usage.\n- **🏆 Insulter Role** — Auto-assigned to top insulter.\n\n**Settings:**\n- **📅 Insulter Days (1–3650)** — Time range for top insulter.\n- **📢 Monitor Channel** — Logs config changes & events.\n- **📝 Insults Channel** — Logs all recorded insults.\n- **🎯 Radar Mode** — Off | Blame | Delete | Both.\n- **👑 View Configuration** — Shows all server settings.\n\n**Permissions:**\n- Requires **Manage Server** permission.'
  },
  'anti-spam': {
    name: 'anti-spam',
